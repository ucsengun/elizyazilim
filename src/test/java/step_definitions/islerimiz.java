...
public class islerimiz {
    ...
    public void marmaraÇimentoTıkla() {
        
    }

    @And("bütad tıkla.")
    public void bütadTıkla() {
        
    }

    @And("ntm elektrik elektronik tıkla.")
    public void ntmElektrikElektronikTıkla() {
        
    }

    @And("cey yatırım tıkla.")
    public void ceyYatırımTıkla() {
        
    }

    @And("ceylan group tıkla.")
    public void ceylanGroupTıkla() {
        
    }

    @And("şantes incinerator tıkla.")
    public void şantesIncineratorTıkla() {
        
    }

    @And("toptan kozmetik tıkla.")
    public void toptanKozmetikTıkla() {
        
    }

    @And("ulusoy elektrik tıkla.")
    public void ulusoyElektrikTıkla() {
        
    }

    @And("polsan tıkla.")
    public void polsanTıkla() {
        
    }

    @And("türk silahlı kuvvetleri tıkla.")
    public void türkSilahlıKuvvetleriTıkla() {
        
    }

    @And("gintek tıkla.")
    public void gintekTıkla() {
        
    }

    @And("ata tenis tıkla.")
    public void ataTenisTıkla() {
        
    }

    @And("seza inşaat tıkla.")
    public void sezaInşaatTıkla() {
        
    }

    @And("mutlu tohum tıkla.")
    public void mutluTohumTıkla() {
        
    }

    @And("söğüt inşaat tıkla.")
    public void söğütInşaatTıkla() {
